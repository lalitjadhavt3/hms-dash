...
const Appointments: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const calendarEvents = mockAppointments.map((appointment) => {
      ...
      return {
        ...
        extendedProps: {
          calendar: appointment.type === 'opd' ? 'OPD' : 'IPD',
  ...
  const handleEventClick = (clickInfo: EventClickArg) => {
    ...
    setSelectedPatient(event.extendedProps.patientId || "");
    setSelectedDoctor(event.extendedProps.doctorId || "");
    setAppointmentType(event.extendedProps.type || "opd");
    openModal();
  };
  ...
  return (
    <>
      <PageMeta
        title="Appointments | HMS Dashboard"
        description="Appointment management page for Hospital Management System"
      />
      <PageBreadcrumb pageTitle="Appointments" />
      <div className="space-y-6">
        <ComponentCard title="Appointment Calendar" desc="Manage patient appointments and schedules">
          ...
          <div className="flex flex-col px-2 overflow-y-auto custom-scrollbar">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Schedule or edit patient appointments
              </p>
            </div>
